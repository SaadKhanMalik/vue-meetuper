  ...
  <div class="meetup-detail-page">
    <section class="hero">
      <div class="hero-body">
        <div class="container">
          <h2 class="subtitle">
            {{ meetup.startDate | formatDate('LL') }}
          </h2>
          <h1 class="title">
            {{ meetup.title }}
          </h1>
      ...
      <div class="container">
        <div class="columns">
            ...
            <aside class="is-medium menu">
              <div class="meetup-side-box">
                <div class="meetup-side-box-date m-b-sm">
                  ...
                  <p>{{ meetup.startDate | formatDate('LL') }}</p>
                </div>
                <div class="meetup-side-box-date m-b-sm">
                  <p>
                    <b>Time</b>
              ...
              <!-- Threads Start -->
              <p  v-if="threadHasData()" class="menu-label">Threads</p>
              <ul>
          ...
          <div class="column is-7 is-offset-1">
            ...
            <!-- Thread List START -->
            <div class="content is-medium">
              <h3  v-if="threadHasData()" class="title is-3">Threads</h3>
              <div 
                class="box"
